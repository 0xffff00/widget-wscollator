...
public class ImageTransformUtils {
	 ...
	 * @param h
	 * @return
	 * @deprecated recommend to use java.awt.image.BufferedImage.getSubimage
	 *             instead
	 * @see java.awt.image.BufferedImage#getSubimage
	 */
	public static BufferedImage crop(BufferedImage origin, int x, int y, int w, int h) {
	...
	/**
	 * put a few images in a column to merge them into one, the result image is
	 * width is determined by the first image
	 * 
	 * @param imgs
	 *            images to be merged
	 * @param n_paddings
	 *            the top(north) padding height of every image ,which need be
	 *            cut off.
	 * @param s_paddings
	 *            the bottom(south) padding height of every image ,which need be
	 *            cut off.
	 * @return
	 */
